...
@section('page-content')
    ...
    <form class="pt-3 pl-4 pb-2 editForm" method="post" action="/delete/member/{{ $member->id }}">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input readonly type="date" class="form-control @error('joining_date') is-invalid @enderror" value="{{ old('joining_date') ?? $member->joining_date }}" id="joining_date" name="joining_date" placeholder="">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input readonly type="tel" class="form-control @error('mobile_no') is-invalid @enderror" value="{{ old('mobile_no') ?? $member->mobile_no }}" id="mobile_no" name="mobile_no" placeholder="01700000000">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input readonly type="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') ?? $member->email }}" id="email" name="email" placeholder="israkahmed7@gmail.com">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input readonly type="text" class="form-control @error('address') is-invalid @enderror" value="{{ old('address') ?? $member->address }}" id="address" name="address" placeholder="123 Main St, Cityville">
